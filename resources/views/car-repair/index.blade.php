    ...
    <header>
      <div class="main">
        ...
        <div class="slider-wrapper">
          <div class="slider">
            <ul class="items">
              <li> <img src="{{asset('car-repair/images/slider-img1.jpg')}}" alt="" /> </li>
              <li> <img src="{{asset('car-repair/images/slider-img2.jpg')}}" alt="" /> </li>
              <li> <img src="{{asset('car-repair/images/slider-img3.jpg')}}" alt="" /> </li>
            </ul>
          </div>
        ...
        <div class="container_12">
          <div class="wrapper p5">
            <article class="grid_4">
              <div class="wrapper">
                <figure class="img-indent"><img src="{{asset('car-repair/images/page1-img1.png')}}" alt=""></figure>
            ...
            <article class="grid_4">
              <div class="wrapper">
                <figure class="img-indent"><img src="{{asset('car-repair/images/page1-img2.png')}}" alt=""></figure>
                <div class="extra-wrap">
            ...
            <article class="grid_4">
              <div class="wrapper">
                <figure class="img-indent"><img src="{{asset('car-repair/images/page1-img3.png')}}" alt=""></figure>
                <div class="extra-wrap">
                  ...
                  <article class="grid_4">
                    <div class="indent-left2 indent-top">
                      <div class="box p4">
                        <div class="padding">
                          <div class="wrapper">
                            <figure class="img-indent"><img src="{{asset('car-repair/images/page1-img4.png')}}" alt=""></figure>
                            <div class="extra-wrap">
